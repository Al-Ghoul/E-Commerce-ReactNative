  ...
  return (
    <SafeAreaView>
      <ScrollView
        refreshControl={
          <RefreshControl
            refreshing={getOrderReq.isPending}
            onRefresh={getOrderReq.refetch}
          />
        }
      >
        <Tabs.Screen
        ...
        {getOrderReq.isFetching || getOrderReq.isPending ? (
          <View className="m-auto my-5 w-6 h-6 rounded-full animate-spin border-y border-solid border-primary border-t-transparent"></View>
        ) : (
          <Card className="mx-3">
            <CardHeader>
